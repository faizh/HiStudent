...
<body id="page-top">
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      <h1 class="mb-1">HiStudent</h1>
      <h3 class="mb-5">
        <em>A Website to Manage School Activity</em>
      </h3>
      <a class="btn btn-primary btn-xl js-scroll-trigger" href="/login">Login Here</a>
    </div>
      ...
      <div class="row no-gutters">
        <div class="col-lg-6">
          <a class="portfolio-item" href="#">
            ...
            <img class="img-fluid" src="home/img/portfolio-1.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-6">
          <a class="portfolio-item" href="#">
            ...
            <img class="img-fluid" src="home/img/portfolio-2.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-6">
          <a class="portfolio-item" href="#">
            ...
            <img class="img-fluid" src="home/img/portfolio-3.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-6">
          <a class="portfolio-item" href="#">
            ...
            <img class="img-fluid" src="home/img/portfolio-4.jpg" alt="">
          </a>
        </div>
      </div>
    </div>
